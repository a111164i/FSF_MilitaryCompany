...
class aEP_DecoRevoController(var weapon: WeaponAPI) {
  companion object {
    ...
    init {
      ...
      mag["aEP_fga_shuangshen3_wing_l"] = arrayOf(0f, -30f, 4f)
      mag["aEP_fga_shuangshen3_wing_r"] = arrayOf(0f, 30f,  4f)
      mag["aEP_fga_shuangshen3_empennage_l"] = arrayOf(0f, -10f, 4f)
      mag["aEP_fga_shuangshen3_empennage_r"] = arrayOf(0f, 10f,  4f)
