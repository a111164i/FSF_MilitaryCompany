package data.missions.aEP_planet_investigation;
...
public class MissionDefinition implements MissionDefinitionPlugin
{
  ...
  public void defineMission(final MissionDefinitionAPI api) {
    ...
    api.addBriefingItem(txt("aEP_Mission05_03"));
    api.addBriefingItem(txt("aEP_Mission05_04"));
    api.addBriefingItem(txt("aEP_Mission05_05"));

    //在这加自己的船，用装配文件的ID，后面是船名，true和false是“是否是旗舰”的设定
    // Set up the player's fleet.  Variant names come from the
    // files in data/variants and data/variants/fighters
    String name1 = "决心";
    api.addToFleet(FleetSide.PLAYER, "aEP_cap_duiliu_Standard", FleetMemberType.SHIP, name1, true);
    api.addToFleet(FleetSide.PLAYER, "aEP_cru_shanhu_Standard", FleetMemberType.SHIP, false);
    api.addToFleet(FleetSide.PLAYER, "aEP_des_shuishi_Standard", FleetMemberType.SHIP, false);
    api.addToFleet(FleetSide.PLAYER, "aEP_des_shuishi_Standard", FleetMemberType.SHIP,  false);
    api.addToFleet(FleetSide.PLAYER, "aEP_des_shuishi_Standard", FleetMemberType.SHIP,  false);
    api.addToFleet(FleetSide.PLAYER, "aEP_fga_wanliu_Standard", FleetMemberType.SHIP,  false);
    api.addToFleet(FleetSide.PLAYER, "aEP_fga_wanliu_Standard", FleetMemberType.SHIP,  false);
